...
using TitanControl.Controls.Layout;
...
namespace TitanControl.Controls.Handle
{
    ...
    public abstract class HandleBaseControl : ContentControl
    {
        ...
        public static readonly StyledProperty<Bitmap?> ImageProperty =
            AvaloniaProperty.Register<HandleButtonControl, Bitmap?>(nameof(Image));

        public static readonly StyledProperty<bool> HasImageProperty =
            AvaloniaProperty.Register<HandleButtonControl, bool>(nameof(HasImage), false);

        public static readonly StyledProperty<string> HaloProperty =
             AvaloniaProperty.Register<HandleButtonControl, string>(nameof(Halo), "#4A5562");
